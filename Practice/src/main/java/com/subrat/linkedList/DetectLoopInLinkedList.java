...
import com.subrat.linkedList.ReturnStartNodeOfLoopInLinkList.Node;
...
public class DetectLoopInLinkedList{
	 ...
	 public static void main(String[] args) {
	  ...
	  Node n1 = detectLoopInLinkedList.new Node(10);
	  Node n2 = detectLoopInLinkedList.new Node(20);
	  Node n3 = detectLoopInLinkedList.new Node(30);
	  Node n4 = detectLoopInLinkedList.new Node(40);
	  Node n5 = detectLoopInLinkedList.new Node(50);
	  Node n6 = detectLoopInLinkedList.new Node(60);
	  Node n7 = detectLoopInLinkedList.new Node(70);
	  Node n8 = detectLoopInLinkedList.new Node(80);
